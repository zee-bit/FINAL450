...
bool isIsomorphic(Node *root1, Node *root2) {
    ...
    bool leftS = isIsomorphic(root1 -> left, root2 -> left);
    bool rightS = isIsomorphic(root1 -> right, root2 -> right);
...
bool isIsomorphic2(Node *root1, Node *root2) {
    ...
    bool noSwap = isIsomorphic2(root1 -> left, root2 -> left) && isIsomorphic2(root1 -> right, root2 -> right);
    bool onSwap = isIsomorphic2(root1 -> left, root2 -> right) && isIsomorphic2(root1 -> right, root2 -> left);
    
    return noSwap || onSwap;
}
